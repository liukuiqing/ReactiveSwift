...
private class EventTransformingCore<Value, Error: Swift.Error, SourceValue, SourceError: Swift.Error>: SignalProducerCore<Value, Error> {
...
private class EventGeneratingCore<Value, Error: Swift.Error>: SignalProducerCore<Value, Error> {
